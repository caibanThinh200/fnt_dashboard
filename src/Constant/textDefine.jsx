const TEXT_DEFINE = {
    PAGE: {
        ...
        NEW: {
            title: 'Bảng tin',
            title_name: 'Tiêu đề bảng tin',
            content: 'Nội dung bảng tin',
            thumb: 'Hình ảnh bảng tin',
            type: 'Loại bảng tin',
            code: 'Mã bảng tin',
            created_at: 'Ngày tạo',
            updated_at: 'Ngày cập nhật',
        ...
        LAYOUT: {
            ...
            name: 'Tên chủ cửa hàng',
            introduce: "Giới thiệu cửa hàng",
            phone: 'SDT liên lạc',
            store: 'Cơ sở',
            store_name: 'Tên cơ sở',
            store_address: 'Địa chỉ',
            district: 'Quận',
            city: 'Thành phố',
            social: 'Mạng xã hội',
            social_type: 'Nền tảng',
            social_link: 'Link kết nối',
            title_name: 'Tiêu đề thông tin',
            tab_icon: 'Tab icon',
            store_logo: 'Ảnh logo',
            code: 'Mã thông tin',
            created_at: 'Ngày tạo',
    ...
    VALIDATE: {
        ...
        product: {
            ...
            isPercent:
                'Nếu chọn giảm theo phần trăm thì giá trị giảm không được vượt quá 100',
